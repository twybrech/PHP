...
$app->match('/bookFile', function() use ($app) {
    return $app['twig']->render('bookFile.html.twig',array(
        'book' => $app['model']->getBook($_GET['bookId']),
        'copies' => $app['model']->getCopies($_GET['bookId'])
    ));
})->bind('bookFile');
